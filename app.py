...
【最重要】
- 今回は「お題に合っていること」よりも、「言い方カードにしっかり寄っていること」を強く優先する。
- 3つのカエルは発想の方向を変えるための補助軸であり、言い方カードより優先してはいけない。
- 回答だけを聞いた人が、言い方カードを知らなくても「これは『{style}』っぽい」と感じられる程度まで、語尾・語彙・リズム・雰囲気・形式を寄せる。
- 出力前に3回答それぞれについて、言い方カードらしさが弱くないか確認し、弱ければ言い換えてから出力する。
...
【回答品質の優先順位】
1. 言い方カード「{style}」らしさが明確に出ている。
2. 5〜6歳が聞いて意味や場面を想像できる。
3. 「なるほど」と「ちょっと変で面白い」が両方ある。
4. 既知の言葉を中心にしつつ、3回答のうち最大1つだけ少し新しい語彙を混ぜてよい。

【ルール】
- 3回答は発想を重複させない。
- 通常は短い一言を優先する。ただし「回りくどく」「映画・ドラマのセリフ風に」「歌の歌詞風に」「詩的に」など、言い方カードの特徴を出すために必要なら1〜2文程度まで長くしてよい。
